  ...
  return (
    <div className="w-full border rounded-xl p-4 bg-transparent border-primary/20 flex gap-3.5 items-start mt-3 select-none text-right">
      ...
      <div className="flex-1 min-w-0">
        <span className="text-xs font-bold text-foreground font-iran-yekan block">امکان تحویل حضوری</span>
        <p className="text-[10px] md:text-xs text-muted-foreground leading-relaxed mt-1 font-iran-yekan">
